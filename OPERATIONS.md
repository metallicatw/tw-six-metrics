...
**〔回補歷史股價〕** 只要跑一次（約一小時）：個股頁〔股價健診〕要 760 個交易日
的每日收盤（500 天的圖＋240 天的年線），每日排程只從 2025-09 開始累積。補齊之後
每日排程每天加一天，不必再跑。可以重跑——只補缺的、或只有半個市場的日子。
跑之前，〔股價健診〕的年線與總評分只有最後幾天有值；那是資料不夠長，不是壞了。
